...
func (OptionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_fee63a4fb3f7e386, []int{0}
}
...
func init() { proto.RegisterFile("common.proto", fileDescriptor_common_fee63a4fb3f7e386) }

var fileDescriptor_common_fee63a4fb3f7e386 = []byte{
